...
Forecasts are produced in Python using MLForecast. MLForecast handles multi-step targets and lag/transform feature generation for each series. The base learner is LightGBM trained with the quantile objective. <br> 
...
Very well!  
<br><br>
 But remember, just assuming it won't change works pretty well, so predicting the absolute value is not that hard.
 <br><br>
...
Box folder for TNC staff with data and symbolology [here](https://tnc.box.com/s/b488ihv2pa3j81qrm8qgsct1e14ivyfp)
...
<b>Send your feedback to glenn.moncrieff@tnc.org</b>
</div>
